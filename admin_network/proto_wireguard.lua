...
peer_ip = section:taboption(
  "general",
  Value,
  "peer_ip",
  translate("Peer IPv4 Addresses"),
  translate("Peer IPv4 addresses of the WireGuard interface.")
)
peer_ip.datatype = "ipaddr"
peer_ip.optional = true

peer_ip6 = section:taboption(
  "general",
  Value,
  "peer_ip6",
  translate("Peer IPv6 Addresses"),
  translate("Peer IPv6 addresses of the WireGuard interface.")
)
peer_ip6.datatype = "ipaddr"
peer_ip6.optional = true
